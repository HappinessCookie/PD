...
?>
            ...
            <div id="page" class="container">
                ...
                <div class="palette clearfix">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                        <img src="/bitrix/templates/web20/images/analiz.png" alt="" class="img-responsive col-center analize-img">
                    </div>
    ...
    <div class="clearfix"><img src="/bitrix/templates/web20/images/pencil.png" alt="" class="pencil col-center"></div>
    </div>
        </div>
        ...
        <div id="page" class="container">
            ...
            <div class="division-info clearfix">
                <h2>Архитектурно-строительный раздел (АС) </h2>
                <p>- положение объекта с планированием территории;</p>
                <p>- экстерьер объекта;</p>
                <p>- экспликация помещений здания;</p>
                <p>- 3D объекта;</p>
                <p>- конструктивные решения наземной части строения;</p>
                <p>- конструктивные решения подземной части строения.</p>

                <p>Данный раздел ориентирован на Заказчика и Строителя. Проектной 							организации требуется выполнить раздел на основании Эскизного проекта*, основанную на идее Заказчика и Архитектора. Объект здания и сооружения в проекте раздела АС учитывается окружающая среда, ландшафтные характеристики участка, требования строительных норм и правил. В раздел АС входит конструктивные решения (КР) наземной и подземной части строения, которые необходимы непосредственно строителям объекта. Раздел КР гарантирует безопасность эксплуатации здания, где учитываются все несущие характеристики материалов, покрытий, узлов, оснований и фундамента.</p>

                <p>Любое здание или сооружение представляет собой сложной техническое решение, которая требует точных и тщательной разработанных разделов проекта, а так же высокого профессионализма специалистов в области проектирования и строительства.</p>
            </div>
            <div class="division-info clearfix">
                <h2>Архитектурный раздел (АР) </h2>
                <p>- положение объекта с планированием территории;</p>
                <p>- экстерьер объекта;</p>
                <p>- экспликация помещений здания; </p>
                <p>- 3D объекта;</p>
                <p>Данный раздел ориентирован на Заказчика. На первом этапе разработки данного раздела является эскизный проект здания сооружения. Обычно это набросок от руки или 3D моделирование объекта, которые учитывают индивидуальные особенности экстерьера здания. На втором этапе разрабатывается зонирование территории с учетом размещения объекта, его объемные пропорции и стилистическую привязанность к месту застройки.</p>
            ...
            <div class="division-info clearfix">
            <h2>КР (конструктивные решения)</h2>
            ...
            <p>Над данным разделом работают конструкторы, которые описывают и обосновывают технические решения здания, с учетом розы ветров, действующих нагрузок на здание, - от здания на фундамент, монтажные схемы и пояснительные записки, а так же рассчитываются узловые соединения, конструктивные элементы и детали соединения всего здания.</p>
            ...
            <div class="division-info clearfix">
            <h2>КМД (конструкции металлические деталировочные)</h2>
            ...
            <div class="division-info clearfix">
                <h2>ПЗУ (Схема планировочной организации земельного участка) или Генплан</h2>
            ...
            <div class="division-info clearfix">
                <h2>Раздел основания и фундаменты.</h2>
            ...
            <div class="division-info clearfix">
                <h2>Раздел Электроосвещение (ЭО) и Электрооборудование (ЭМ)</h2>
                <p>Данный раздел включает в себя несколько этапов проектирование электрики, а именно:</p>
                <p>- расчет вводно-распределительных систем;</p>
                <p>- расчет электрической сети по допустимой потере напряжения;</p>
                <p>- расчет систем заземления;</p>
                <p>- расчет дизельного и стабилизированного электрического питания;</p>
                <p>- расчет токов короткого замыкания.</p>
            </div>
            <div class="division-info clearfix">
                <h2>Проект «Интерьер»</h2>
                ...
                <p>Выполнение данного этапа проектирования позволяет обеспечить точные сроки выполнения отдельных и ремонтных работ, с участием авторов проекта легко контролировать процесс воплощения идеи в реальность, провести анализ затрат на интерьер, определиться с поставщиком мебели и отделки помещения, а в некоторых случаях получить и скидку от поставщика за счет обращения через проектное бюро. </p>
            </div>
            <div class="division-info clearfix">
                <h2>Макетирование</h2>
                <p>Макетирование это один из этапов проектирования здания, сооружения, интерьера или элемента конструкции. Моделирование объекта делится на несколько типов и видов, начиная от использование материалов макетирования и заканчивая детализацией и проработкой элементов макета. В зависимости от назначения объекта (демонстрационный, рабочий, научный или технологический) и цели макетирования выбирается и масштаб будущей модели. </p>
